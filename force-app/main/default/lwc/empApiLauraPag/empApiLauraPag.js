...
export default class EmpApiLauraPag extends LightningElement {
    channelName = '/event/Test__e';
    quoteId = 'a0q8Z00000CsqYPQAZ'; //  a0q8Z00000CsZBaQAN
    ...
    handleSaveAndCalculate(){
        ...
        this.template.querySelector("c-emp-child-laura-pag").calculate();
    }

    handleSaveAndExit(){
        this.template.querySelector('c-emp-child-laura-pag').exit();
    }

    handleCloneRows(){
        this.template.querySelector('c-emp-child-laura-pag').clonerows();
    }
    ...
    handleReorderLines(){
        ...
        this.template.querySelector("c-emp-child-laura-pag").reorderLines();
    }
